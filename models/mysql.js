...
var queries = { //list of mysql queries
    ...
    completeMilestone: "UPDATE milestones JOIN projects ON (milestones.project_id = projects.id) SET completed_at = CURRENT_DATE() WHERE milestones.id = ? AND projects.user_id = ?",
